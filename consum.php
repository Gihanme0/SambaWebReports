...
<head>
    ...
    <title>Consumption Vouchers</title>
    ...
    <form action="consum.php" class="form" method="post"  role="form">
        <fieldset>
            ...
            <div class="form-group">
                <label for="dtp_input1" class="col-md-12 col-sm-12 col-xs-12 col-lg-12 control-label">Choose Start Date</label>
                <div class="input-group date form_datetime_raport1 col-md-8 col-sm-8 col-xs-8 col-lg-8" data-date="" data-date-format="dd-mm-yyyy" data-link-field="dtp_input1">
                    <input class="form-control" size="16" type="text" placeholder="Click here to enter date" name="startdate" value="" readonly>
			...
			<div class="form-group">
                <label for="dtp_input4" class="col-md-12 col-sm-12 col-xs-12 col-lg-12 control-label">Choose End Date</label>
                <div class="input-group date form_datetime_raport1 col-md-8 col-sm-8 col-xs-8 col-lg-8" data-date="" data-date-format="dd-mm-yyyy" data-link-field="dtp_input4">
                    <input class="form-control" size="16" type="text" placeholder="Click here to enter date" name="enddate" value="" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
					<div class="spacer"></div>
                </div>
				<button type="submit" class="col-md-4 col-sm-4 col-xs-4 col-lg-4 btn btn-default buton-actiune">Show</button>
